...
<body>
    ...
    <!-- Core Vendors JS -->
    <script src="{{    }}a }}sset('assets/js/vendors.min.js') }}"></script>

    <!-- page js -->
    <script src="{{    }}a }}sset('assets/vendors/chartjs/Chart.min.js') }}"></script>
    <script src="{{    }}a }}sset('assets/js/pages/dashboard-default.js') }}"></script>

    <!-- Core JS -->
    <script src="{{    }}a }}sset('assets/js/app.min.js') }}"></script>
